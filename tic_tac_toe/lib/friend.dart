...
class AgainstFriend extends StatefulWidget {
  @override
  _AgainstFriendState createState() => new _AgainstFriendState();
}

class _AgainstFriendState extends State<AgainstFriend> {
